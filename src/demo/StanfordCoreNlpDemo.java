    ...
    if (sentences != null && ! sentences.isEmpty()) {
     ...
     // out.println();
      ...
      for (CoreMap token : sentence.get(CoreAnnotations.TokensAnnotation.class)) {
          ...
          out.println("The keys of the first tokens CoreMap are:");
          out.println(token.keySet());
          out.println("The token  POS tags are:");
          out.println(token.get(CoreAnnotations.PartOfSpeechAnnotation.class));
          out.println();
          out.println("The token  NER tags are:");
          out.println(token.get(CoreAnnotations.NamedEntityTagAnnotation.class));
          out.println();
          out.println("The token Lemma tags are:");
